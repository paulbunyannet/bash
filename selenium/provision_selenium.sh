...
if [ -e /.sssInstalled ]; then
  ...
  # Install Java, firefox, Xvfb, dbus, libvpx and firefox
  sudo yum -y install java-1.8.0-openjdk-headless.x86_64 xorg-x11-server-Xvfb.x86_64 dbus libvpx firefox

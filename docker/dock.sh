...
DOCKTOTALMIN=$(expr $DOCKTOTAL / $SIXTY );
DOCKTOTALREST=$(expr $DOCKTOTALMIN * $SIXTY );
DOCKTOTALSEC=$(expr $DOCKTOTAL - $DOCKTOTALREST );
GRUNTTOTAL=$(expr $GRUNTEND - $GRUNTSTART );
GRUNTTOTALMIN=$(expr $GRUNTTOTAL / $SIXTY );
GRUNTTOTALREST=$(expr $GRUNTTOTALMIN * $SIXTY );
GRUNTTOTALSEC=$(expr $GRUNTTOTAL - $GRUNTTOTALREST );
GULPTOTAL=$(expr $GULPEND - $GULPSTART );
GULPTOTALMIN=$(expr $GULPTOTAL / $SIXTY );
GULPTOTALREST=$(expr $GULPTOTALMIN * $SIXTY );
GULPTOTALSEC=$(expr $GULPTOTAL - $GULPTOTALREST );
COMPOSERTOTAL=$(expr $COMPOSEREND - $COMPOSERSTART );
COMPOSERTOTALMIN=$(expr $COMPOSERTOTAL / $SIXTY );
COMPOSERTOTALREST=$(expr $COMPOSERTOTALMIN * $SIXTY );
COMPOSERTOTALSEC=$(expr $COMPOSERTOTAL - $COMPOSERTOTALREST );
MIGRATIONTOTAL=$(expr $MIGRATIONEND - $MIGRATIONSTART );
MIGRATIONTOTALMIN=$(expr $MIGRATIONTOTAL / $SIXTY );
MIGRATIONTOTALREST=$(expr $MIGRATIONTOTALMIN * $SIXTY );
MIGRATIONTOTALSEC=$(expr $MIGRATIONTOTAL - $MIGRATIONTOTALREST );
YARNTOTAL=$(expr $YARNEND - $YARNSTART );
YARNTOTALMIN=$(expr $YARNTOTAL / $SIXTY );
YARNTOTALREST=$(expr $YARNTOTALMIN * $SIXTY );
YARNTOTALSEC=$(expr $YARNTOTAL - $YARNTOTALREST );
NPMTOTAL=$(expr $NPMEND - $NPMSTART );
NPMTOTALMIN=$(expr $NPMTOTAL / $SIXTY );
NPMTOTALREST=$(expr $NPMTOTALMIN * $SIXTY );
